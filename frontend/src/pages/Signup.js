    ...
    <section className="px-5 lg:px-0">
      <div className="max-w-[900px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="hidden lg:block h-[520px] bg-primaryColor rounded-l-lg  ">
            <figure className="rounded-l-lg">
              <img
                src={signupImg}
                alt=""
                className="w-full h-[510px] rounded-l-lg "
              />
            </figure>
          </div>
          <div className="rounded-l-lg lg:pl-16 py-8">
            ...
            <form onSubmit={submitHandler}>
              ...
              leading-7 text-darkColor placeholder:text-gray-600 cursor-pointer"
                  required
                />
              </div>
              <div className="mb-5">
              ...
              <div className="mb-5 flex items-center justify-between">
                <label className="text-darkColor font-bold text-[16px] leading-7">
                  Are you a:
                  <select
                    name="role"
                    value={formData.role}
